...
namespace TrainManager.Brake
{
	public abstract class CarBrake
	{
		...
		public ReverserHandle reverserHandle;
		...
		public EletropneumaticBrakeType electropneumaticBrakeType;
		...
		public AccelerationCurve[] decelerationCurves;
		...
		public double GetRate(double Ratio, double Factor)
		{
